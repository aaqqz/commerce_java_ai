...
**관련 파일:**
- `core/core-api/src/main/java/io/dodn/commerce/core/domain/CartService.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/domain/OrderService.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/domain/PaymentService.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/domain/PointService.java`
...
**관련 파일:**
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/v1/ProductController.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/v1/OrderController.java`
...
**관련 파일:**
- `core/core-api/src/main/java/io/dodn/commerce/core/domain/`
...
- `core/core-api/src/main/java/io/dodn/commerce/core/domain/OrderService.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/domain/PaymentService.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/domain/ReviewService.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/domain/QnAService.java`
...
### 4.1 변환 로직 위치 불일치
**현상:**
- `CartService.getCart()`: 서비스 내부에서 직접 엔티티를 도메인 객체로 변환
- `PointService.balance()`, `histories()`: 서비스 내부에서 변환
...
**관련 파일:**
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/v1/request/AddCartItemRequest.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/v1/request/ModifyCartItemRequest.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/v1/request/CreateOrderRequest.java`
...
**관련 파일:**
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/v1/response/CartResponse.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/v1/response/OrderCheckoutResponse.java`
...
**관련 파일:**
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/HealthController.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/batch/SettlementBatchController.java`
...
**관련 파일:**
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/v1/CartController.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/v1/OrderController.java`
...
- 엔티티 메서드에서 검증 및 보정: `CartItemEntity.applyQuantity()` - `value < 1 ? 1 : value`
...
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/v1/request/CreateOrderRequest.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/v1/request/AddCartItemRequest.java`
- `storage/db-core/src/main/java/io/dodn/commerce/storage/db/core/CartItemEntity.java`
...
### 8.1 하드코딩된 값들
**현상:**
- `PaymentService.success()` 내부에서 결제 수단과 승인 번호가 하드코딩되어 있음
- `OrderService.create()` 내부에서 주문명 접미사가 하드코딩되어 있음
...
- NOTE 주석이 여러 곳에서 사용되지만 목적이 다양함
  - 구현 필요 표시: `PaymentService.success()`
  - 비즈니스 규칙 설명: `PointHandler`
  - 설계 고민 표시: `ProductController.findProduct()`
  - 배치 실행 시간 명시: `SettlementBatchController`
...
**관련 파일:**
- `core/core-api/src/main/java/io/dodn/commerce/core/domain/PaymentService.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/domain/PointHandler.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/v1/ProductController.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/api/controller/batch/SettlementBatchController.java`
...
**현상:**
- `User` 클래스가 단순 데이터 홀더: `record User(Long id)`
- `PaymentService`에서 `new User(payment.getUserId())` 형태로 직접 생성
...
**관련 파일:**
- `core/core-api/src/main/java/io/dodn/commerce/core/domain/User.java`
- `core/core-api/src/main/java/io/dodn/commerce/core/domain/PaymentService.java`
...
**관련 파일:**
- `storage/db-core/src/main/java/io/dodn/commerce/storage/db/core/CartItemEntity.java`
- `storage/db-core/src/main/java/io/dodn/commerce/storage/db/core/PaymentEntity.java`
- `storage/db-core/src/main/java/io/dodn/commerce/storage/db/core/BaseEntity.java`
...
- 일부 API는 `ApiResponse<Object>` 반환 (CartController)
- 일부 API는 `ResponseEntity<Void>` 반환 (HealthController)

**문제점:**
- API 응답 타입이 일관되지 않음
- `ApiResponse<Object>`는 타입 안정성 저하
